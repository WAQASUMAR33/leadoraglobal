  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-64">
        ...
        <p className="text-gray-600 mt-4">Loading package requests...</p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        {packageRequests.length === 0 ? (
          ...
          packageRequests.map((request) => (
            <div key={request.id} className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
              {/* Request Header */}
                 ...
                 {request.transactionReceipt && (
                   <div className="mb-6">
                     ...
                     <div className="max-w-xs">
                       <img
                         src={request.transactionReceipt}
                       ...
                       <div className="p-4 bg-gray-100 rounded-lg border border-gray-300 hidden">
                         ...
                         <a
                           href={request.transactionReceipt}
                           target="_blank"
